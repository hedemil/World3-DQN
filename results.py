...
world3_run = World3(year_max=2205, dt=1)
world3_run.set_world3_control()
world3_run.init_world3_constants()
world3_run.init_world3_variables()
world3_run.set_world3_table_functions()
world3_run.set_world3_delay_functions()
world3_run.run_world3(fast=False)

variables = [world3_optimal.le, world3_run.le]
labels = ["LE", "LE STD"]
...
plot_world_variables(
    ...
    labels,
        [[0, 100], [0, 100]],
    figsize=(10, 7),
    title="World3 Simulation from 1900 to 2200"
)
